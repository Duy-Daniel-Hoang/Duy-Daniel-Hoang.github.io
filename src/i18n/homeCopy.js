...
export const HOME_COPY = {
  en: {
    ...
    skillsLabel: "04 · Skills", skillsTitle: "Where the years went", skillsDesc: "Years of hands-on experience per area, out of seven years in AI/ML.", core: "Core AI / ML", tools: "Tools & Infra",
  ...
  vi: {
    ...
    skillsLabel: "04 · Kỹ năng", skillsTitle: "Kinh nghiệm chuyên môn", skillsDesc: "Số năm kinh nghiệm thực chiến trong từng lĩnh vực, trên tổng hành trình hơn bảy năm AI/ML.", core: "Năng lực AI / ML", tools: "Công cụ & Hạ tầng",
