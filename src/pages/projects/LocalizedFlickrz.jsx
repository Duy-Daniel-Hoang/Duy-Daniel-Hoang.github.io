  ...
  return <>
    ...
    <main>
      ...
      <section className="case-section"><div className="wrap-wide"><h2 className="case-h2"><span className="case-num">04</span>{c.sampleTitle}</h2><div className="case-body"><p>{c.sample}</p></div>
        <div className="demo-group"><div className="demo-group-label"><span className="age-badge age-badge--ok">{c.allAges}</span></div><div className="demo-video-frame demo-video-frame--full"><video src="/assets/flickrz/vid3.mp4" poster="/assets/flickrz/vid3-poster.webp" playsInline preload="metadata" tabIndex={-1} disablePictureInPicture onContextMenu={(e) => e.preventDefault()} /></div></div>
