...
function LocalizedContent({ c }) {
  ...
  return <>
    ...
    <main>
      ...
      <section className="case-section"><div className="wrap-wide"><h2 className="case-h2"><span className="case-num">02</span>{c.pipelineTitle}</h2>{c.pipeline.map((p, index) => <div className="case-body" style={index ? { marginBottom: 8 } : undefined} key={p}><p>{p}</p></div>)}<div className="pipeline-split"><AgentFlow steps={steps} /><div className="pipeline-diagram-card"><AgentFlowDiagram /></div></div><CapabilityGrid items={stack} /></div></section>
      <section className="case-section"><div className="wrap-wide"><h2 className="case-h2"><span className="case-num">03</span>{c.sampleTitle}</h2><div className="case-body"><p>{c.sample}</p></div>
      ...
      <section className="case-section"><div className="wrap-wide"><h2 className="case-h2"><span className="case-num">04</span>{c.adminTitle}</h2><div className="case-body"><p>{c.admin}</p></div><ShotsGrid shots={shots} /></div></section>
